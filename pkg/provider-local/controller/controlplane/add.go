...
func AddToManagerWithOptions(ctx context.Context, mgr manager.Manager, opts AddOptions) error {
	genericActuator, err := genericactuator.NewActuator(mgr, local.Name, getSecretConfigs, nil, nil, controlPlaneChart, controlPlaneShootChart,
		nil, storageClassChart, NewValuesProvider(mgr.GetClient()), extensionscontroller.ChartRendererFactoryFunc(util.NewChartRendererForShoot),
